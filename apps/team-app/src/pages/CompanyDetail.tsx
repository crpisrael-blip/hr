...
interface AgreementRow { id: string; version: number; commission_pct: number; commission_base: string; warranty_days: number; installments: number; payment_terms_days: number; valid_from: string }
